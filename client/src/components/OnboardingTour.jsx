...
export default function OnboardingTour({ onComplete }) {
  ...
  const steps = [
    ...
    },
    {
      ...
      subtitle: 'Delivered at 08:00 AM Africa/Lagos',
      ...
      highlight: 'Every morning at 8:00 AM (Nigeria time), your exact assigned daily devotion will arrive quietly in your inbox.',
      icon: '✉️',
      targetPath: '/settings',
    },
    {
    ...
    },
    {
      ...
      highlight: 'Your next morning devotional will arrive automatically tomorrow at 08:00 AM.',
      icon: '✨',
      targetPath: '/home',
    },
  ];
